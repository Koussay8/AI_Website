...
// /:https://framerusercontent.com/modules/dMJRonQ4JUL7rdRXcc7N/ojOIult3ddU3UafTXMFR/iWR0Rmd6I.js
					...
					>
						...
						>
							...
							>
								{_jsx3(stdin_default, {
									aU1_lXl6h:
										"Nous automatisons les tâches répétitives, le support client, la qualification de leads, la prise de rendez-vous et plus encore.",
									height: "100%",
									id: "zdAQaCiXj",
									layoutId: "zdAQaCiXj",
									pNqA5B2sU: "Quels types de processus pouvez-vous automatiser ?",
									style: {
										width: "100%",
									},
									variant: "QAvUnlGpo",
						...
						>
							...
							>
								{_jsx3(stdin_default, {
									aU1_lXl6h:
										"Pas du tout. Notre équipe gère la configuration, l'intégration et l'optimisation. Vous vous concentrez sur vos objectifs, nous automatisons le reste.",
									height: "100%",
									id: "crxJ1ydLD",
									layoutId: "crxJ1ydLD",
									pNqA5B2sU:
						...
						>
							...
							>
								{_jsx3(stdin_default, {
									aU1_lXl6h:
										"Oui ! Nous nous intégrons à vos CRM, outils de gestion de projet, applications de communication et plus encore, adaptés à votre stack.",
									height: "100%",
									id: "oWeDSST6C",
									layoutId: "oWeDSST6C",
									pNqA5B2sU: "Pouvez-vous vous intégrer à nos outils existants ?",
									style: {
										width: "100%",
									},
									variant: "SF38uWa4S",
						...
						>
							...
							>
								{_jsx3(stdin_default, {
									aU1_lXl6h:
										"La plupart des clients voient leur première automatisation en ligne sous 2 à 4 semaines, selon la complexité.",
									height: "100%",
									id: "io9j_bFtM",
									layoutId: "io9j_bFtM",
									pNqA5B2sU: "Combien de temps prend la mise en place ?",
									style: {
										width: "100%",
									},
									variant: "SF38uWa4S",
						...
						>
							...
							>
								{_jsx3(stdin_default, {
									aU1_lXl6h:
										"Absolument. Nous utilisons des pratiques de sécurité de niveau entreprise et assurons la conformité avec les normes de confidentialité des données.",
									height: "100%",
									id: "RMiXR9cAd",
									layoutId: "RMiXR9cAd",
									pNqA5B2sU: "Votre IA est-elle sécurisée et conforme ?",
									style: {
										width: "100%",
									},
									variant: "SF38uWa4S",
